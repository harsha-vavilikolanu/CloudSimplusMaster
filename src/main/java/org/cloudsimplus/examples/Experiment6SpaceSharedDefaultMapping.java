...
public class Experiment6SpaceSharedDefaultMapping {
    ...
    static void main() {
        new Experiment6SpaceSharedDefaultMapping();
    }

    private Experiment6SpaceSharedDefaultMapping() {
        ...
        System.out.println(
                "\nSPACE SHARED DEFAULT TASK TO VM MAPPING");
