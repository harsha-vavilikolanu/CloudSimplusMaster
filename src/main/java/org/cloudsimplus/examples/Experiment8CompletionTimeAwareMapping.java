...
public class Experiment8CompletionTimeAwareMapping {
    ...
    static void main() {
        new Experiment8CompletionTimeAwareMapping();
    }

    private Experiment8CompletionTimeAwareMapping() {
        ...
        System.out.println(
                "\nCOMPLETION-TIME-AWARE TASK TO VM MAPPING");
    ...
    private void performCompletionTimeAwareMapping() {
        ...
        System.out.println(
                "\nCOMPLETION-TIME-AWARE MAPPING DECISIONS");

        for (Cloudlet cloudlet : sortedCloudlets) {

            int selectedVm = 0;

            long minimumEstimatedCompletion =
                    vmWorkload[0]
                            + cloudlet.getLength();
